...
router.get("/wards", requireRole("Admin", "Nurse", "Doctor"), listWards);
router.post("/wards", requireRole("Admin"), createWard);
router.get("/beds", requireRole("Admin", "Nurse", "Doctor"), listBeds);
router.post("/beds", requireRole("Admin"), createBed);
router.put("/beds/:id/status", requireRole("Admin", "Nurse"), updateBedStatus);
