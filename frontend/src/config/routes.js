...
export const roleRoutes = {
  ...
  manageUsers: { label: "Manage Users", icon: UserCog, roles: ["Admin"], view: "placeholder", placeholder: true },
  managePatients: { label: "Manage Patients", icon: Users, roles: ["Admin"], view: "managePatients" },
  manageDoctors: { label: "Manage Doctors", icon: Stethoscope, roles: ["Admin"], view: "manageDoctors" },
  manageNurses: { label: "Manage Nurses", icon: Users, roles: ["Admin"], view: "manageNurses" },
  ...
  inventory: { label: "Inventory", icon: Pill, roles: ["Admin"], view: "placeholder", placeholder: true },
  ...
  bookAppointment: { label: "Book Appointment", icon: CalendarDays, roles: ["Admin", "Patient"], view: "bookAppointment" },
  ...
  payments: { label: "Payments", icon: CreditCard, roles: ["Admin", "Patient"], view: "payments" },
  ...
  registerPatientReception: { label: "Register Patient", icon: Users, roles: ["Receptionist", "Admin"], view: "managePatients" },
  receptionBookAppointment: { label: "Book OPD Appointment", icon: CalendarDays, roles: ["Receptionist", "Admin"], view: "bookAppointment" },
  ...
  receptionRecordPayment: { label: "Record Payment", icon: CreditCard, roles: ["Receptionist", "Admin"], view: "payments" }
};
